...
def getNextVersion(year):
    query = "SELECT next_version FROM version "
    update = "UPDATE version SET next_version = next_version + 1 "
    # values = (str(year))
    version = 0
...
def refreshAllGameData(year):
    ...
    # TODO include the version number in the stats
